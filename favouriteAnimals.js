...
function createAnimalList(){
    animals.forEach((animal) => {
        ...
        // 1b.  Add a button to remoce the element from the list
...
function removeAnimalFromList(targetAnimalId){
    // 1. Find element in list with matchin ID
    ...
    animals = animals.filter(ainmal => {
        if (targetAnimalId == ainmal){
    ...
    // 4. Update or wipe & rebuild the animla list HTML
}
